<template>
  <div class="filter-event">
    <div class="event">
      ...
      <Button @click="handleAddCondition" class="item2" :disabled="single && conditions.length > 0">
    ...
    <div class="array">
      <MutableArray :value="conditions" :init-item="initItem" :on-delete="handleDelete">
        <template #item="itemProps">
            <IndiceCondition3 v-bind="itemProps" />
        </template>
      </MutableArray>
    </div>
  </div>
...
<script>
  import IndiceCondition3 from '../base/IndiceCondition3';
  ...
  export default {
    ...
    components: {IndiceCondition3, MutableArray},
    props: {
      title: String,
      suffix: String,
      showEvent: Boolean,
