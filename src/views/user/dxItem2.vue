        ...
        <div class="test_container">
            ...
            <div class="per_info_container">
                <div class="yhdx_title">
                    <div class="yhdx_title_lef">
                    <img :src="yhdxImg" alt="" class="pic">
            ...
            <div class="yhxw_container">
                ...
                <div class="bqitm_container">
                    <div class="bqitm">
                        ...
                        <div class="bqitm_rig">
                            <img :src="xhsIcon" alt="" class="bqimg">
                            <img :src="ksIcon" alt="" class="bqimg" style="margin-left: -8px;">
                            <img :src="wbIcon" alt="" class="bqimg" style="margin-left: -8px;">
                        </div>
                    </div>
                    <div class="bqitm">
                        <div class="bqitm_lef" style="color: #017AFF;">新闻</div>
                        <div class="bqitm_rig">
                            <img :src="ttIcon" alt="" class="bqimg">
                            <img :src="wyIcon" alt="" class="bqimg" style="margin-left: -8px;">
                            <img :src="zhIcon" alt="" class="bqimg" style="margin-left: -8px;">
                        </div>
                    </div>
                    <div class="bqitm">
                        <div class="bqitm_lef" style="color: #5AC8FA;">视频</div>
                        <div class="bqitm_rig">
                            <img :src="dyIcon" alt="" class="bqimg">
                            <img :src="wbIcon" alt="" class="bqimg" style="margin-left: -8px;">
                            <img :src="ksIcon" alt="" class="bqimg" style="margin-left: -8px;">
                        </div>
                    </div>
...
<script>
    export default {
        ...
        mounted(){
            ...
            this.initMap(path,path1,path2,cir1);
        },
        methods:{
            clickTime(arg){
            this.current = arg;
